...
class Thread {
  ...
  int InWhichQueue();
  // Whether to aging.
  void set_wait_starttime(int tick){this->start_wait_ticks = tick;}
  ...
  double approx_bursttime;
  double last_approx_bursttime;
  int True_ticks; // T.
  int cpu_start_ticks;
  int cpu_end_ticks;
...
//   	call ThreadBegin
//	call "func" ( this thread function! => its user program.)
