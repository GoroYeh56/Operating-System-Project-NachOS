...
{
    file->WriteAt((char *)map, numWords * sizeof(unsigned), 0);//write buffer"map" to on-Disk sector of this openfile "file"
}                                       // write numWords*sizeof(unsigned) from position 0.(in-file position)
